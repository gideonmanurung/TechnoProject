...
<div class="container  bg-1 text-center">
  <h2>Layanan Motor</h2><br><br>
 <div class="row">
   <div class="col-sm-6 text-center">
     <label>Service</label><br>
     <a href="{{url('pesananServiceMotor')}}"><img src="images/service.jpg" width="200" height="200"></a>
   </div>
   <div class="col-sm-6 text-center">
   ...
   <div class="col-sm-6 text-center">
     ...
     <a href="{{url('pesananSparepartMotor')}}"><img src="images/sukucadang.jpg" width="200" height="200"></a>
   </div>
   <div class="col-sm-6 text-center">
